...
export const RoomCard = ({ room }: { room: Room }) => {
  return (
    <li>
      <button className="flex flex-col items-stretch w-full text-start">
        ...
        <div className="flex items-start justify-between text-lg mt-3 pb-11">
          ...
          <div className="min-w-[90px] h-[29px] bg-primary rounded-[4px] text-white text-xs font-bold flex items-center justify-center">
            Book!
          </div>
        </div>
      </button>
